      ...
      <div className="mt-6 border-t border-gray-20 pt-4">
        ...
        <div className="mt-1 space-y-2 text-xs">
          {weeks.map((week, wIndex) => (
            <div
              key={wIndex}
              className="relative min-h-30 border-t border-gray-10"
            >
              {/* 날짜 숫자 그리드 */}
              <div className="grid grid-cols-7">
                {week.map(({ date, isCurrentMonth }, dIndex) => {
                  const baseCell = "px-2 pt-2 pb-3 min-h-20";
              ...
              <div className="pointer-events-none absolute inset-x-0 top-6 px-2">
